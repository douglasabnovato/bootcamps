...
export const events: BootcampEvent[] = [
  {
    ...
    content: {
      longDescription:
        "A 42 é uma escola de engenharia de software disruptiva. O aprendizado é baseado em projetos, colaboração e correção entre pares (P2P), sem professores ou salas de aula tradicionais.",
  ...
  },
  {
    ...
    content: {
      longDescription:
        "Treinamento focado em criar interfaces modernas, performáticas e escaláveis, utilizando as melhores práticas do mercado como Design Patterns e Clean Code.",
      videoUrl: "",
      curriculum: [
        "React Hooks",
        "Context API",
  ...
  },
  {
    ...
    content: {
      longDescription:
        "Uma jornada completa pelos fundamentos do Java, explorando desde a sintaxe básica até frameworks robustos para o mercado corporativo.",
      videoUrl: "",
